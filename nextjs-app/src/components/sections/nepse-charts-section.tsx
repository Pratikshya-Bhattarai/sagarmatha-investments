...
export default function NEPSEChartsSection() {
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">Loading NEPSE market data...</p>
          </div>
        </div>
      </section>
    );
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-red-600 mb-4">Error Loading Market Data</h2>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="h-80">
              {getVolumeChartData() && (
                <Bar data={getVolumeChartData()!} options={volumeChartOptions} />
              )}
            </div>
          </div>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {data.stocks.slice(0, 10).map((stock, idx) => (
